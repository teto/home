...
let
  ...
  # was just used to test an alternative neovim
  # pluginsMap = pkgs.callPackage ../../hm/profiles/neovim/plugins.nix {};
  #
  # allPlugins = 
  ...
  # ;
  #
  # # This is a backup neovim built in case the one generated by home-manager stops working
  # myNvimConfig = pkgs.neovimUtils.makeNeovimConfig {
  #
  #   plugins = allPlugins;
  #
  # };
  # myNvim = pkgs.wrapNeovimUnstable pkgs.neovim-unwrapped myNvimConfig;
