...
let
  ...
  fastmail =
    accountExtra //
    {
      ...
      mujmap = {
        ...
        settings.password_command = hmUtils.getPassword "perso/fastmail_mc_jmap";
  ...
  nova = # {{{
    accountExtra //
    {
      ...
      passwordCommand = hmUtils.getPassword "nova/mail";
    };
  # }}}
  ...
  gmail = accountExtra // {
    ...
    passwordCommand = hmUtils.getPassword "perso/gmail";
  };
